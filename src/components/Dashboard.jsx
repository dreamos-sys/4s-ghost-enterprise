      ...
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logout-btn {
          ...
          font-family: 'Courier New', monospace; font-size: 0.7rem; transition: all 0.3s;
        }
        .logout-btn:hover { background: #ef4444; color: #000; }
        .stats {
          display: grid; grid-template-columns: repeat(2, 1fr); gap: 0.8rem; margin-bottom: 1rem;
        }
        .stat {
          background: rgba(0, 255, 157, 0.05); border: 1px solid #00ff9d33;
        ...
        .tool {
          background: rgba(0, 255, 157, 0.03); border: 1px solid #00ff9d22;
          border-radius: 8px; padding: 0.8rem; cursor: pointer; transition: all 0.2s; text-align: center;
        }
        ...
        .tool-status {
          display: inline-block; font-size: 0.55rem; padding: 0.15rem 0.5rem;
          border-radius: 10px; background: rgba(16, 185, 129, 0.2); color: #10b981; border: 1px solid #10b981;
        }
        .footer {
          text-align: center; margin-top: 1.5rem; padding: 1rem;
          border-top: 1px solid #00ff9d22; font-size: 0.6rem; color: #00ff9d44;
        }
