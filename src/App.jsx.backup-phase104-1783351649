      ...
      return (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ color: '#ef4444', fontFamily: "'Orbitron', monospace", fontSize: '1.2rem' }}>
              SYSTEM ERROR
            </h2>
            ...
            <p style={{ fontSize: '0.5rem', color: '#64748b', marginTop: '1rem' }}>
          ...
          <div style={{ padding: '0.8rem', maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <div style={{
              background: error
                ...
                : 'linear-gradient(135deg, rgba(0,255,157,0.05), rgba(14,165,233,0.05))',
              border: error
              ...
              <div style={{
                ...
                <div>
                  <h2 style={{
                    ...
                    color: error ? '#ef4444' : '#00ff9d',
                    margin: 0
                  }}>
                    4S GHOST v1.0
                  </h2>
                  <p style={{ fontSize: '0.6rem', color: '#94a3b8', margin: '0.2rem 0' }}>
                    {error ? '⚠️ System Error Detected' : 'Cyber Defense & Bug Bounty Suite'}
                  </p>
                  {error && (
                    <p style={{ fontSize: '0.55rem', color: '#ef4444', margin: '0.3rem 0' }}>
                      Error: {error.message}
                    </p>
                  )}
                </div>
                ...
                <div style={{ display: 'flex', gap: '0.8rem' }}>
                  {[
                    ...
                    { value: error ? 'ERR' : 'OK', label: 'Status' },
                    { value: '1.03', label: 'Phase' }
                  ].map((stat, i) => (
                    <div key={i} style={{ textAlign: 'center' }}>
                      <div style={{
                        fontSize: '0.8rem',
                        fontWeight: 700,
                        color: stat.value === 'ERR' ? '#ef4444' : '#00ff9d',
                        fontFamily: "'Orbitron', monospace"
                      }}>
                        {stat.value}
                      </div>
              ...
              {activeTool && (
                <div style={{
                  ...
                  <span><strong>{activeTool.name}</strong> {loading ? 'loading...' : 'activated'}</span>
            ...
            <div style={{
              ...
              {tools.map((tool, i) => (
                ...
                >
                  <div style={{ fontSize: 'clamp(1.2rem, 4vw, 1.8rem)', marginBottom: '0.3rem' }}>
                    {tool.icon}
                  </div>
                  <div style={{ fontSize: 'clamp(0.55rem, 1.5vw, 0.65rem)', fontWeight: 700, color: '#e2e8f0' }}>
                    {tool.name}
                  </div>
                  <div style={{ fontSize: 'clamp(0.45rem, 1vw, 0.5rem)', color: '#64748b', marginTop: '0.1rem' }}>
                    {tool.desc}
                  </div>
                  <div style={{
                    position: 'absolute',
            ...
            <div style={{
              ...
              <span style={{ fontSize: '0.4rem' }}>FAMILY DREAM TEAM • PHASE 1.03 • ERROR HANDLING ACTIVE</span>
            </div>
          </div>
        </div>
