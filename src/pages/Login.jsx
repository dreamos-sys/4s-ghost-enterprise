    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-lg">
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-32 h-32 bg-gradient-to-br from-blue-600 via-purple-600 to-cyan-600 rounded-3xl mb-6 shadow-[0_0_60px_rgba(6,182,212,0.6)] animate-[pulse_3s_ease-in-out_infinite]">
            <img 
              src="/icon-192.png" 
              alt="DREAMS Logo" 
          ...
          <h1 className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 mb-4 animate-[glow_3s_ease-in-out_infinite]">
            DREAMS
          </h1>
        ...
        <div className="bg-slate-900/90 backdrop-blur-2xl rounded-3xl p-10 border border-cyan-500/40 shadow-[0_0_60px_rgba(6,182,212,0.3)]">
          <div className="flex items-center gap-3 mb-8 pb-5 border-b border-slate-700/60">
            ...
            <span className="text-base font-mono text-cyan-400">AUTHENTICATION_TERMINAL</span>
          </div>

          {error && (
            <div className="mb-8 p-5 bg-red-500/20 border border-red-500/60 rounded-xl flex items-center gap-3 text-red-400">
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-5 py-4 bg-slate-950/90 border border-cyan-500/40 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 text-white placeholder-slate-600 font-mono text-sm"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-5 px-8 bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 hover:from-cyan-500 hover:via-blue-500 hover:to-purple-500 text-white font-semibold rounded-xl shadow-[0_0_40px_rgba(6,182,212,0.5)] transition-all duration-500 disabled:opacity-50 flex items-center justify-center gap-4"
            >
              {loading ? (
                <>
                ...
                <>
                  ...
                  <span className="font-mono text-lg">INITIATE_LOGIN_SEQUENCE</span>
                </>
              )}
            </button>
          </form>
          ...
          <div className="mt-8 p-6 bg-cyan-500/10 border border-cyan-500/40 rounded-xl">
            <p className="text-xs text-cyan-400 text-center font-mono mb-4 uppercase">
              // DEMO_ACCESS_CREDENTIALS
            </p>
            <div className="space-y-3 text-xs font-mono">
              <p className="text-slate-400 text-center">
                Email: <code className="text-cyan-400">admin@dreamos.dev</code>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="text-slate-600 text-xs font-mono">
            © 2026 DREAMS Enterprise. System ID: DRE-ENT-001
          </p>
        </div>
      </div>
